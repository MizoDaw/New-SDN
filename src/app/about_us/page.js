    ...
    <div className='AboutUs_page'>
      ...
      <div className='AboutUs_BG'>      
        ...
        <p className='AboutUs_p'> 
          {/* {Frist_Section} */}
        {t("SDNone is a leading digital marketing agency that specializes in providing innovative and result-driven  solutions to help businesses thrive in the digital landscape. With a team of seasoned experts and a deep understanding of the latest trends in online marketing, we empower our clients to achieve their marketing goals and stay ahead of the competition.")}
        {t("Our Approach:")}
        {t("At SDNone, we believe in the power of creativity, data-driven strategies, and cutting-edge technology to deliver exceptional results. We tailor our approach to each client s unique needs and develop customized  digital marketing campaigns that drive measurable outcomes.")}
        {t("Services")}
